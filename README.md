...
| `CORS_HOSTS: <IPs delimited by ,>`<br/> *Advanced/Optional* | List of domains/subdomains on which [CORS](https://en.wikipedia.org/wiki/Cross-origin_resource_sharing) is allowed. Does not support wildcard. Eg. `CORS_HOSTS: home.domain.com,www.domain.com,domain.com`
